...
/*!****************************!*\
  !*** ./js/cruises/card.js ***!
  \****************************/
/*! exports provided: checkerOnClickLink, checkerOffClickLink */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkerOnClickLink", function() { return checkerOnClickLink; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkerOffClickLink", function() { return checkerOffClickLink; });
var cruises = document.querySelectorAll('.cruise');
...
var onFocusListener = function onFocusListener(item) {
  item.addEventListener('click', onClick);
};

var onFocusCard = function onFocusCard() {
  cruises.forEach(function (item) {
    item.addEventListener('focus', onFocusListener(item));
  });
};

var offClickCard = function offClickCard() {
  cruises.forEach(function (item) {
...
var checkerOnClickLink = function checkerOnClickLink() {
...
var checkerOffClickLink = function checkerOffClickLink() {
  if (desktop.matches) {
    offClickCard();
  }
};
...
/* harmony import */ var _cruises_card__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cruises/card */ "./js/cruises/card.js");
...
var cruisesCards = document.querySelectorAll('cruises li');
var cruisesLink = document.querySelector('cruises__link');
window.addEventListener('DOMContentLoaded', function () {
  ...
  navToggle.addEventListener('click', function (event) {
    ...
    if (nav.classList.contains('nav--closed')) {
      ...
      document.addEventListener('click', function (evt) {
        evt.stopPropagation();
        var withinBoundaries = evt.composedPath().includes(navWrapper);
  ...
  window.addEventListener('load', function () {
    ...
    var _iterator2 = _createForOfIteratorHelper(cruisesCards),
        _step2;

    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var cruisesCard = _step2.value;
    ...
    Object(_cruises_card__WEBPACK_IMPORTED_MODULE_2__["checkerOnClickLink"])();
    Object(_cruises_card__WEBPACK_IMPORTED_MODULE_2__["checkerOffClickLink"])();
  });
});
